...
interface ProjectsApiInterface
{
     ...
     * @param  int $offset   (optional, default to 0)
     * @param  string $flavor   (optional)
     * @param  string $program_id   (optional)
     * @param  integer $responseCode     The HTTP response code to return
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
     * @return OpenAPI\Server\Model\ProjectResponse[]
     *
     */
    public function projectsGet(string $category, string $accept_language = null, string $max_version = null, int $limit = 20, int $offset = 0, string $flavor = null, string $program_id = null, &$responseCode, array &$responseHeaders);
