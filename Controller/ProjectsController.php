...
class ProjectsController extends Controller
{
    ...
    public function projectsGetAction(Request $request)
    {
        ...
        try {
            ...
            $offset = $this->deserialize($offset, 'int', 'string');
            $flavor = $this->deserialize($flavor, 'string', 'string');
            $program_id = $this->deserialize($program_id, 'string', 'string');
        } catch (SerializerRuntimeException $exception) {
            return $this->createBadRequestResponse($exception->getMessage());
        }
        ...
        $asserts = [];
        $asserts[] = new Assert\NotNull();
        $asserts[] = new Assert\Choice([ "recent", "random", "most_viewed", "most_downloaded", "example", "scratch", "more_from_this_user", "user_also_downloaded" ]);
        $asserts[] = new Assert\Type("string");
        ...
        $asserts[] = new Assert\Type("string");
        $asserts[] = new Assert\Regex("/^[a-zA-Z0-9\\-]+$/");
        $response = $this->validate($program_id, $asserts);
        if ($response instanceof Response) {
            return $response;
        }
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->projectsGet($category, $accept_language, $max_version, $limit, $offset, $flavor, $program_id, $responseCode, $responseHeaders);
